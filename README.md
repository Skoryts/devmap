...
- [**Каждый уважающий себя разработчик должен знать:**](#Каждый-уважающий-себя-разработчик-должен-знать-)
    ...
    - [x] [Архитектура компьютера](#Архитектура-компьютера-)
...
- Полезные ресурсы:
    - [x] [Duolingo](https://www.duolingo.com/)
    - [x] [Lingualeo](https://lingualeo.com/)
...
- [x] [Underscore - набор полезных функций](http://underscorejs.org/)
- [x] [Modernizr - обнаруживает HTML5 и CSS3 функции в браузере пользователя](https://modernizr.com/)
...
- [x] Изучить:
    - [x] [JavaScript фреймворки](#javascript-фреймворки-)
    - [x] Роутинг
    - [x] Шаблонизатор
    - [x] API, например REST
    - [x] AJAX
